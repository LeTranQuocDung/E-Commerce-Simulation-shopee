    ...
    <header>
        ...
        <div class="shopee-header-main">
            <div class="container d-flex align-items-center gap-4">
                ...
                <a href="cart" class="shopee-cart-icon"><i class="fas fa-shopping-cart"></i>
                    <% 
        // Đoạn này lấy giỏ hàng từ session để hiển thị số lượng thực tế
        model.Cart c = (model.Cart) session.getAttribute("cart");
        int count = (c != null) ? c.getTotalQuantity() : 0;
    %>
                    <span class="cart-badge"><%= count %></span></a>
            </div>
        </div>
    </header>
