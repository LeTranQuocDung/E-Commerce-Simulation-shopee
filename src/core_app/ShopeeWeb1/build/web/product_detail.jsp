...
<html lang="vi">
        ...
        <div class="container">
            ...
            <div class="product-wrapper">
                ...
                <div class="col-right">
                   ...
                   <form id="buyForm" action="cart" method="post">
    ...
    <div class="option-row" style="align-items: center;">
        ...
        <div class="qty-input-group">
            ...
            <input type="text" name="quantity" value="1" class="qty-value" id="qtyInput" readonly>
            <button type="button" class="qty-btn" onclick="updateQty(1)">+</button>
        </div>
...
<button type="button" class="btn btn-buy-now" onclick="buyNow()">Mua Ngay</button>
    ...
    if (val >= 1) {
        ...
        function buyNow() {
    // 1. Đặt giá trị action là 'buynow'
    document.getElementById('actionInput').value = 'buynow';
    // 2. Vẫn gửi đến CartServlet để nó kịp thêm hàng vào giỏ
    document.getElementById('buyForm').action = 'cart'; 
